...
const SiteDetail = () => {
    ...
    useEffect(() => {
        setLoading(true);
        setError(null);
        const siteWatch = CreateWatch(
            `/api/v1alpha1/backbones/${backboneId}/sites`,
            function (message) {
        ...
        const linkWatch = CreateWatch(
            `/api/v1alpha1/backbonesites/${siteId}/links`,
            function (message) {
                const body = message.body;
                if (body.method === "GET" || body.method === "UPDATE") {
                    if (body.statusCode >= 200 && body.statusCode < 300) {
    ...
    return (
        <div className="page-container">
            <Breadcrumb>
                ...
                <BreadcrumbItem isCurrentPage>{site?.name || siteId}</BreadcrumbItem>
            </Breadcrumb>
            ...
            {loading && <Loading description="Loading site details..." withOverlay={false} />}
