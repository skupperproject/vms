...
const SiteDetail = () => {
  ...
  const fetchPeerAccessPoints = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `/api/v1alpha1/backbones/${backboneId}/accesspoints`,
      )
            ...
            try {
              ...
              if (ap.interiorsite) {
                const siteResponse = await fetch(
                  `/api/v1alpha1/backbonesites/${ap.interiorsite}`,
                )
                if (siteResponse.ok) {
  ...
  const handleCreateLink = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/v1alpha1/accesspoints/${selectedPeerAP}/links`,
        {
          method: "POST",
          headers: {
  ...
  const handleEditLink = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/v1alpha1/backbonelinks/${linkToEdit.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleCreateAccessPoint = async () => {
    ...
    try {
      ...
      for (const kind of selectedApKinds) {
        ...
        const response = await fetch(
          `/api/v1alpha1/backbonesites/${siteId}/accesspoints`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleDeleteAccessPoint = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/v1alpha1/accesspoints/${apToDelete.id}`,
        {
          method: "DELETE",
        },
      )
  ...
  return (
    <div className="page-container">
      ...
      {!loading && !error && site && (
        <>
          ...
          <Tile style={{ marginBottom: "1rem" }}>
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontWeight: 500 }}>
                  {site.platformlong || site.targetplatform || "N/A"}
                </p>
              </div>
              <div>
                <p
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            {loadingAccessPoints && (
              <Loading
                description="Loading access points..."
                withOverlay={false}
              />
            )}
                ...
                <div>
                  ...
                  <Tile>
                    <p style={{ color: "#525252", fontStyle: "italic" }}>
                      No access points configured for this site. Click "New
                      Access Point" to create one.
                    </p>
                  </Tile>
                </div>
              )}
                                    ...
                                    <TableCell key={cell.id}>
                                      ...
                                      >
                                        <IconButton
                                          ...
                                          tooltipPosition="top"
                                          onClick={() =>
                                            handleDeleteAPClick(cell.value)
                                          }
                                          size="sm"
                                        >
                                          <TrashCan />
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            {loadingOutgoingLinks && (
              <Loading
                description="Loading outgoing links..."
                withOverlay={false}
              />
            )}
            ...
            {!loadingOutgoingLinks &&
              ...
              outgoingLinks.length === 0 && (
                <div>
                  ...
                  <Tile>
                    <p style={{ color: "#525252", fontStyle: "italic" }}>
                      No outgoing links configured for this site. Click "New
                      Link" to create one.
                    </p>
                  </Tile>
                </div>
                                    ...
                                    <TableCell key={cell.id}>
                                      ...
                                      >
                                        <IconButton
                                          ...
                                          tooltipPosition="top"
                                          onClick={() =>
                                            handleEditLinkClick(cell.value)
                                          }
                                          size="sm"
                                        >
                                          <Edit />
      ...
      >
        ...
        <p>
          Are you sure you want to delete the access point{" "}
          <strong>{apToDelete?.name}</strong>? This action cannot be undone.
        </p>
      </Modal>
      ...
      >
        ...
        {loadingPeerAPs ? (
          <Loading
            description="Loading peer access points..."
            withOverlay={false}
          />
        ) : (
          <>
        ...
        {linkToEdit && (
          <>
            <div style={{ marginBottom: "1rem" }}>
              ...
              <p style={{ fontWeight: 500 }}>
                {linkToEdit.formattedAccessPoint}
              </p>
            </div>
