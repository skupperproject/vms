    ...
    return (
        <div className="page-container">
            ...
            <div className="page-header">
                ...
                <p>
                    Manage network backbone configurations and connections. Click on a backbone to
                    view its sites.
                </p>
            </div>

            {loading && <Loading description="Loading backbones..." withOverlay={false} />}
            ...
            >
                ...
                <p style={{ marginBottom: "1rem" }}>
                    ...
                    <strong>{backboneToDelete?.name}</strong>? This will also delete all sites in
                    this backbone. This action cannot be undone.
                </p>
