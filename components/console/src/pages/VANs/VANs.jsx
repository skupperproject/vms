            ...
            <div style={{ marginBottom: "1rem", maxWidth: "300px" }}>
                ...
                >
                    ...
                    {backbones.map((backbone) => (
                        <SelectItem key={backbone.id} value={backbone.id} text={backbone.name} />
                    ))}
                </Select>
            </div>

            {loading && <Loading description="Loading VANs..." withOverlay={false} />}
                                    ...
                                    {rows.map((row) => (
                                        <TableRow {...getRowProps({ row })} key={row.id}>
                                            {row.cells.map((cell) => {
                                                ...
                                                if (
                                                    cell.info.header === "starttime" ||
                                                    cell.info.header === "endtime"
                                                ) {
                                                    return (
                                                        <TableCell key={cell.id}>
                                                                ...
                                                                {showConsole && (
                                                                    <IconButton
                                                                        ...
                                                                        label={
                                                                            canOpenConsole
                                                                                ? "VAN Console"
                                                                                : "VAN Console (connect VAN first)"
                                                                        }
                                                                        tooltipPosition="top"
                                                                        onClick={() =>
                                                                            handleVANConsole(van)
                                                                        }
