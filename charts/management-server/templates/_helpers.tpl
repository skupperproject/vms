...
*/}}
{{- define "management-server.chart" -}}
...
helm.sh/chart: {{ include "management-server.chart" . }}
...
*/}}
{{- define "management-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "management-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
