    ...
    try {
        ...
        issuer_list.forEach((issuer) => {
            if (
                ...
                issuer.metadata.annotations &&
                issuer.metadata.annotations[META_ANNOTATION_SKUPPERX_CONTROLLED] == "true"
            ) {
        ...
        secret_list.forEach((secret) => {
            if (
                ...
                secret.metadata.annotations[META_ANNOTATION_SKUPPERX_CONTROLLED] == "true"
            ) {
