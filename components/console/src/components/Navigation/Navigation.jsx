...
import { Dashboard, Network_3, VirtualPrivateCloud, Security } from "@carbon/icons-react";
...
const Navigation = ({ isOpen }) => {
    ...
    return (
        <SideNav aria-label="Side navigation" expanded={isOpen} className="side-nav-container">
            <SideNavItems>
                <SideNavLink
