...
export const MC_IMAGE = process.env.VMS_MC_IMAGE || "vms-management-controller:kind";
export const MC_DEPLOYMENT = process.env.VMS_MC_DEPLOYMENT || "management-server";
export const MC_SERVICE = process.env.VMS_MC_SERVICE || "management-server";
export const MC_CONTROLLER_NAME = process.env.VMS_MC_CONTROLLER_NAME || "skupper-vms-controller";
...
export const KEYCLOAK_ADMIN_USER = process.env.VMS_KEYCLOAK_ADMIN_USER || "integration-admin";
export const KEYCLOAK_ADMIN_PASSWORD =
    process.env.VMS_KEYCLOAK_ADMIN_PASSWORD || "integration-admin";
export const KEYCLOAK_VIEWER_USER = process.env.VMS_KEYCLOAK_VIEWER_USER || "integration-viewer";
