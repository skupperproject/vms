...
const BackboneListView = ({ sites, backboneName, backboneId, backboneOwnerGroup = "" }) => {
        ...
        <>
            {sites.length === 0 ? (
                ...
                <DataTable rows={rows} headers={headers}>
                    {({ rows, headers, getTableProps, getHeaderProps, getRowProps }) => (
                        <TableContainer
                            title="Sites"
                            description={`${sites.length} site(s) in this backbone`}
                        >
                            <TableToolbar>
                                <TableToolbarContent>
                                    <Button
                                                ...
                                                if (cell.info.header === "status") {
                                                    ...
                                                    return (
                                                        <TableCell key={cell.id}>
                                                            <Tag type={tagType}>{statusValue}</Tag>
                                                        </TableCell>
                                                    );
                                                }
            ...
            <Modal
                ...
                primaryButtonDisabled={
                    isCreating || loadingPlatforms || !siteName.trim() || !selectedPlatform
                }
            >
                {createError && (
                    <InlineNotification
