...
A multi-tenant Virtual Application Network solution that controls both the _network topology_ and the _application topology_ of distributed software systems.
